...
class RequestInventory {
  ...
  /* ITEMS GETTERS */
  async getBoard(boardId, retryCount = 0, delay = 1000) {
    try {
  ...
  async getList(listId, retryCount = 0, delay = 1000) {
    try {
  ...
  async getCard(cardId, retryCount = 0, delay = 1000) {
    try {
  ...
  async getBoardLists(boardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
  ...
  async getBoardCards(boardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
  ...
  async getListCards(listId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
  ...
  async getListFromCard(cardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
  ...
  async getOPFTechNumber(cardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
  ...
  async getOPFTechMaxNumber(boardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
  ...
  async getCustomField(cardId, fieldName, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
  ...
  async getCustomFields(cardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
      const response = await axios.get(`https://api.trello.com/1/cards/${cardId}/customFields?key=${this.oauth.apiKey}&token=${this.oauth.appAccessToken}&source=${this.oauth.appName}`, {
        timeout: timeout
      });
  ...
  async getCardCustomFieldValue(cardId, customFieldId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
  ...
  async getCardAttachments(cardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
      const response = await axios.get(
  ...
  async getCardAttachment(cardId, attachmentId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
      const response = await axios.get(
  ...
  // POST
  async addOPFTechNumber(cardId, opfTechNumber, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      let frontText;
      try {
  ...
  async setCustomField(cardId, customFieldId, valueId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
  ...
  async setCardDescription(cardId, cardDescription, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
        const response = await axios.put(
  ...
  async addCardAttachment(cardId, attachmentName, attachmentUrl, mimeType = "url", retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
  ...
  async removeCardAttachment(cardId, attachmentId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
    ...
    /* PUT */
  //PUT JSON
  async setJson(cardId, json, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
        const response = await axios.put(
  ...
  //PUT Card Parameters
  async setCardUpdate(cardId, card, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
        const payload = {};
  ...
  /* CARD ACTIONS */
  async createCard(boardId, listId, cardName, cardDescription, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
    try {
      const response = await axios.post(
  ...
  async moveCardToList(cardId, listId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
        const response = await axios.put(
  ...
  async copyCardToList(cardId, listId, copyData, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
        const response = await axios.post(
  ...
  async archiveCard(cardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
          const response = await axios.put(
  ...
  async deleteCard(cardId, retryCount = 0, delay = 1000, timeout = this.defaultTimeout) {
      try {
        const response = await axios.delete(
          `https://api.trello.com/1/cards/${cardId}?key=${this.oauth.apiKey}&token=${this.oauth.appAccessToken}&source=${this.oauth.appName}`,
          {
