        ...
        return [
            {
                ...
                callback: function (t) {
                    ...
                    t.get('board', 'private', 'initPowerUp')
                        .then(initPowerUp => {
                            if (!initPowerUp) {
                                        ...
                                        if (id && nam) {
                                            ...
                                            t.lists('all')
                                                .then(function (lists) {
                                                    ...
                                                    t.set('board', 'private', 'initPowerUp', true)
                                                        .then(function () {
                                                            console.log('Board added to workspace.');
                                                        })
                                                        .catch(function (error) {
                                                            console.error('Error setting initPowerUp flag:', error);
                                                        });
                                                })
                                                .catch(function (error) {
                                ...
                                console.log('Initialization has already been done.');
                            }
                        });
                },
            },
